...
# Load the datasets
ratings = pd.read_csv('ratings.csv')  # Ensure this file contains 'userId', 'movieId', 'rating' columns
movies = pd.read_csv('movies.csv')    # Ensure this file contains 'movieId', 'title', and 'genres' columns
